...
public class AnimationView extends View {
    public static final int ANIMATION_VIEW_HEIGHT = 100;
    public static final int ANIMATION_VIEW_PULL_DELTA = 50;
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        PULL_HEIGHT = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, ANIMATION_VIEW_HEIGHT, context.getResources().getDisplayMetrics());
        PULL_DELTA = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, ANIMATION_VIEW_PULL_DELTA, context.getResources().getDisplayMetrics());
        mWidthOffset = 0.5f;
    ...
    private static long REL_DRAG_DUR = 0; //200;
